...
namespace TomatoTool
{
	public class MapScriptList : ROMObject, IList
	{
		...
		public static readonly uint MAIN_SIZE = 4;
		...
		public override void save(TomatoAdventure tomatoAdventure, uint address)
		{
			...
			tomatoAdventure.writeAsAddress(address, mainScript.Address);
		...
		{
			return (uint)(MAIN_SIZE + (mapScript.Count * TomatoTool.MapScript.SIZE) + FOOTER_SIZE);
		}
