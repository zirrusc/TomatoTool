...
{
	public class Chip : ICloneable, Loadable, Savable
	{
		...
		public static readonly int WIDTH = TomatoTool.Tile4Bit.WIDTH;
		public static readonly int HEIGHT = TomatoTool.Tile4Bit.HEIGHT;

		public static readonly uint SIZE = 2;
