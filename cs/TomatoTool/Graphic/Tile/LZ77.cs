...
{
	public class LZ77 : Tile4BitList
	{
		public static readonly uint COMPRESSION_BLOCK_LENGTH_0 = 8;

		public static readonly byte HEADER = 0x10;

		public static readonly uint MINIMUM_COMPRESSION_LENGTH_0 = 3;
		public static readonly uint MAXIMUM_COMPRESSION_LENGTH_0 = 0x0F + MINIMUM_COMPRESSION_LENGTH_0;
		...
		public new void save(TomatoAdventure tomatoAdventure)
		{
			if (!saved)
			{
				saved = true;
				...
				address = tomatoAdventure.malloc((uint)compression.GetLength(0));
		...
		protected static int byteArraySearch(byte[] array, int start, int end, byte[] value, int valueLength)
		{
			int j = 0;
			int k = 0;
		...
		public override uint getSize()
		{
			...
			return (uint)LZ77.compression(buffer).GetLength(0);
		}
	}
}