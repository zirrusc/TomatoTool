...
namespace TomatoTool
{
	public class CharacterScript : ROMObject
	{
		...
		public static readonly byte CHARACTER_IMAGE_NUMBER_MAX = 0x0F;
		public static readonly byte PALETTE_NUMBER_MAX = 0x0F;
		...
		public override void save(TomatoAdventure tomatoAdventure, uint address)
		{
			...
			tomatoAdventure.writeAsAddress(address + 6, actionScript.Address);

			tomatoAdventure.writeAsAddress(address + 10, script.Address);
